...
define
    ...
    in
        ...
        %New for Feru Stats
        {System.showInfo "BiggestSenders (top 3):"}
        {System.show {BaseModule.biggestSenders FinalBlockchain 3}}

        {System.showInfo "ReceivedMost (top 3):"}
        {System.show {BaseModule.receivedMost FinalBlockchain 3}}

        {System.showInfo "MoneyPeak:"}
        {System.show {BaseModule.moneyPeak FinalBlockchain}}
    end
